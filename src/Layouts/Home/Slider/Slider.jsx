    ...
    <div className="carousel w-full ">
        ...
        <div className="absolute top-1/3 left-48 lg:left-60 transform -translate-y-1/2 -translate-x-1/2 w-96">
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center">
              <h1 className="text-5xl pt-36 hidden lg:block font-bold mb-4 text-black">
                YOU AND <span className="text-green-600">YOUR DOCTOR</span>
              </h1>
              <p className="text-xs hidden lg:block mt-32 lg:text-xl text-white bg-slate-500 opacity-50 lg:m-6 p-8 rounded-md">
              ...
              <div className="flex hidden lg:block gap-8 mt-16  lg:mt-10 lg:ml-6 px-4 ">
      ...
      <div id="slide1" className="carousel-item relative w-full">
        ...
        <div className="absolute top-1/3 left-60 transform -translate-y-1/2 -translate-x-1/2 w-96">
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center">
              <h1 className="text-5xl hidden lg:block pt-36 font-bold mb-4 text-black">
                YOU AND <span className="text-green-600">YOUR DOCTOR</span>
              </h1>
              <p className="text-xl hidden lg:block text-white bg-slate-500 opacity-50 m-6 p-8 rounded-md">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Asperiores aperiam aliquam porro neque tempora dignissimos quo
                doloribus, at possimus culpa optio nobis explicabo modi minus
                voluptatem accusamus beatae, fuga rem laborum sit reprehenderit
              ...
              <div className="flex gap-8 hidden lg:block mt-10 ml-6 ">
                <div className="checkups flex">
